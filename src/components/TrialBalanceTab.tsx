...
export function TrialBalanceTab({ expenses, sources, accounts, bills = [], billPayments = [], inventoryItems = [], inventoryMovements = [], invoices = [], invoicePayments = [], taxPayments = [] }: Props) {
  ...
  const entries = useMemo(
    () => deriveAllEntries(expenses, sources, accounts, bills, billPayments, inventoryItems, inventoryMovements, invoices, invoicePayments, taxPayments).filter((e) => e.date <= asOf),
    [expenses, sources, accounts, bills, billPayments, inventoryItems, inventoryMovements, invoices, invoicePayments, taxPayments, asOf]
  );
