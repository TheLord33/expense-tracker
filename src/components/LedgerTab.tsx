...
import type { Account, AccountType, Expense, IncomeSource } from "@/lib/types";
...
export function LedgerTab({ expenses, sources, accounts, onAddAccount, onUpdateAccount, onDeleteAccount }: Props) {
